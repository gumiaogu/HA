...
var plant3 = Paper.image('../img/plant3.png', 0, 0, 100, 140).toDefs();
...
plant3.use().transform('t120, 405').click(handlerAft).appendTo(plantArea);

function handlerAft() {
  location.replace('bon_03-8_2(3).html');
}
