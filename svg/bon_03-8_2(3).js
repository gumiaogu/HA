...
var plant4 = Paper.image('../img/plant4.png', 0, 0, 110, 220).toDefs();
...
plant4.use().transform('t110, 325').click(handlerAft).appendTo(plantArea);

function handlerAft() {
  location.replace('bon_03-8_2(4).html');
}
