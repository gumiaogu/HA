...
var plant2 = Paper.image('../img/plant2.png', 0, 0, 100, 90).toDefs();
...
plant2.use().transform('t120, 460').click(handlerAft).appendTo(plantArea);

function handlerAft() {
  location.replace('bon_03-8_2(2).html');
}
